...
#     print(label)
# print(listtrain_loader)
label = list(train_loader)[0][1]
print(label)
...
def main():
    ...
    #     os.mkdir('./save')
    os.makedirs('./save_sphere', exist_ok=True)
    torch.save(EbeddingNet, './save_sphere/Sphere.-{}-pkl'.format(num_epoches))
